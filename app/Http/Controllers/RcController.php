...
class RcController extends Controller
{
    ...
    public function rc(Request $request)
    {
    		...
    		curl_setopt_array($curl, array(
    			CURLOPT_URL => "https://sandbox.flowboard.in/api/v1/rc/rc",
    		...
    		if (!$request->id_number) {
    			return json_encode(['message'=>"Rc number no Not found"], true);
            }
     ...
     public function RcClient($client_id)
    {
    		...
    		$curl = curl_init();
    		curl_setopt_array($curl, array(
    			CURLOPT_URL =>"https://sandbox.flowboard.in/api/v1/rc/rc/".$client_id,
    			CURLOPT_RETURNTRANSFER => true,
    			CURLOPT_ENCODING => "",
    			CURLOPT_MAXREDIRS => 10,
    			CURLOPT_TIMEOUT => 0,
